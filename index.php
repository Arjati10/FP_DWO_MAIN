                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(customer_id) as jumlah_cust from fakta_penjualan";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT COUNT(vendor_id) as jumlah_vendor from vendor";
                                                $query = mysqli_query($conn, $sql);
                                                while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT SUM(order_qty) as Order_Quantity from fakta_penjualan";
                                                $query = mysqli_query($conn, $sql);
                                                while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $sql = "SELECT SUM(subtotal) as LineTotal from fakta_pembelian";
                                                $query = mysqli_query($conn, $sql);
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT SUM(subtotal) as LineTotal from fakta_penjualan";
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0){
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo "$".number_format($row2['LineTotal'],0,".",",");
